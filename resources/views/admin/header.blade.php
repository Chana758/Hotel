          ...
          <div class="navbar-header d-flex align-items-center">
            ...
            <a href="index.html" class="navbar-brand">
              <div class="brand-text brand-big visible text-uppercase brand-logo">
                <strong class="text-primary">Dark</strong><span class="text-white">Admin</span>
              </div>
              <div class="brand-text brand-sm brand-logo">
                <strong class="text-primary">D</strong><span class="text-white">A</span>
              </div>
            </a>
            
            <!-- Sidebar Toggle Btn -->
            <button class="sidebar-toggle btn-toggle-custom">
